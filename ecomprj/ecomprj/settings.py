...
SECRET_KEY = 'django-insecure-dq3fxk%j2wq2rnc@mkid@2pni6_dgp1)5n(9$@t_uzi7@j!)^m'
...
JAZZMIN_SETTINGS = {
    'site_header': "HBR Store",
    'site_brand': "You order, we are deliver",
    # 'site_logo': "static/img/logo.jpeg",
